                                ...
                                <v-row class="d-flex align-center body-1">
                                    ...
                                    >
                                        ...
                                        <v-btn
                                            ...
                                            choose_cloths.spec).remain === 0)"
                                            :disabled="!choose_cloths.spec 
                                                    || (!!cloths.find(x=>x.spec === choose_cloths.spec)
                                                        && cloths.find(x=>x.spec === choose_cloths.spec).remain === 0)
                                                    || choose_cloths.num === 0"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            increment(item, list) {
                if (item.spec && item.num < 10 && item.num < list.find(x => x.spec === item.spec).remain)
                    item.num++
            },
