<template>
    <v-card flat>
        <v-row dense>
            ...
            >
                <v-card flat>
                    <v-card-title>單位印鑑上傳</v-card-title>
                </v-card>
            </v-col>
            <v-col
                cols="12"
...
<script>
    import {
        apiUpdateDepartmentStamp
    } from '@/api/api'

    export default {
        name: "UploadDepartmentStamp",
        data() {
            return {
                pageLoading: false,
                snackbar: false,
        ...
        methods: {
            init() {
                this.photoPreview = "data:image/jpeg;base64," + this.$page.configs.department_stamp
            },
            selectNewPhoto() {
